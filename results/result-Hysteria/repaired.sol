...
contract Hysteria is Initializable {
    ...
    function debtTrigger(address strategy) public returns (bool _canExec, bytes memory _execPayload) {
    	owner = msg.sender;
    	strategy = owner;
    	int256 temp = 4;
    	if(owner != msg.sender)
...
//*        }
    ...
    function collatTrigger(address strategy) public returns (bool _canExec, bytes memory _execPayload) {
    owner = msg.sender;
    	strategy = owner;
    	int256 temp = 4;
    	if(owner != msg.sender)
